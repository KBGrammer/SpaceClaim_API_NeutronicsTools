...
namespace CCFE_Toolbox.CCFE_Commands
{
    ...
    class PipeSeperator : CommandCapsule
    {
        // This command name must match that in the Ribbon.xml file
        //----------------------------------------------------------
        public bool first = true;
        public string directory = @"C:\Program Files\ANSYS Inc\v242\scdm\Addins\NeutronicsTools\Resources\PythonScripts\Cylinder-cylinder_splitter.scscript";
        public const string CommandName = "CCFE_Toolbox.C#.V18.PS";

        public PipeSeperator() : base(CommandName, Resources.PiSepText, Resources.ps_image, Resources.PiSepHint)
        {
